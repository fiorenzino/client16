...
/**
 * This Class enables TLS V1.2 connection based on BouncyCastle Providers. Just to use: URL myurl = new URL( "http://
 * ...URL tha only Works in TLS 1.2); HttpsURLConnection con = (HttpsURLConnection )myurl.openConnection();
